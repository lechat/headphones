...
def initialize():
    ...
    with INIT_LOCK:
        ...
        if CONFIG_VERSION == '1':
            ...
            FILE_FORMAT = helpers.replace_all(FILE_FORMAT, file_values)
            FOLDER_FORMAT = helpers.replace_all(FOLDER_FORMAT, folder_values)
...
def start():
    ...
    global __INITIALIZED__, started, progressLock, progressData
